...
![GitHub Release](https://img.shields.io/github/v/release/mendix/widgets-tools?filter=pluggable-widgets-tools-v*&link=https%3A%2F%2Fgithub.com%2Fmendix%2Fwidgets-tools%2Freleases)
...
Install via NPM using `npm install @mendix/pluggable-widgets-tools` (use [node.js](https://nodejs.org/) version >= 20).
...
Or execute directly with `npx pluggable-widgets-tools task`.
