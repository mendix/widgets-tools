...
export type StartRuleNames = "ChangelogFile";
export interface ParseOptions<T extends StartRuleNames = "ChangelogFile"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"ChangelogFile">>(
  input: string,
  options?: Options,
): any;
